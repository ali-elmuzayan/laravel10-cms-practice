 <head>
    ...
    <link rel="stylesheet" href="{{asset($assetDir)}}/css/select2.css">
    <link rel="stylesheet" href="{{asset($assetDir)}}/css/dropzone.css">
    <link rel="stylesheet" href="{{asset($assetDir)}}/css/uppy.min.css">
    <link rel="stylesheet" href="{{asset($assetDir)}}/css/jquery.steps.css">
    <link rel="stylesheet" href="{{asset($assetDir)}}/css/jquery.timepicker.css">
    <link rel="stylesheet" href="{{asset($assetDir)}}/css/quill.snow.css">
